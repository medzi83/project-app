            ...
            <div key={item.id} className="space-y-2">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
                ...
                <div className="p-4 md:p-6">
                  {/* Hinweise zu Menüpunkten (aus Webdoku Step 3) */}
                  {item.notes && (
                    <div className="mb-4 p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-lg">
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          <p className="text-xs font-medium text-blue-700 dark:text-blue-400 mb-1">Hinweis zu Menüpunkt:</p>
                          <p className="text-sm text-blue-800 dark:text-blue-300">{item.notes}</p>
                        </div>
                      </div>
                    </div>
                  )}
                    ...
                    {child.notes && (
                      <div className="mb-4 p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-lg">
                        <div className="flex items-start gap-2">
                          ...
                          <div>
                            <p className="text-xs font-medium text-blue-700 dark:text-blue-400 mb-1">Hinweis zu Menüpunkt:</p>
                            <p className="text-sm text-blue-800 dark:text-blue-300">{child.notes}</p>
                          </div>
                        </div>
                      </div>
                    )}
