    ...
    <main className="space-y-8">
      <section className="rounded-2xl border bg-card p-6 shadow-sm">
        <header className="mb-6">
          <h1 className="text-2xl font-semibold text-foreground">Mein Kummerkasten</h1>
              ...
              >
                ...
                {feedback.adminResponse && (
                  <div className="space-y-2">
                    <div className="text-xs font-semibold text-green-700 dark:text-green-400">Admin-Antwort:</div>
                    <p className="whitespace-pre-wrap text-sm text-green-900 dark:text-green-100 bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800 rounded p-3">
                      {feedback.adminResponse}
                    </p>
                  </div>
                )}
